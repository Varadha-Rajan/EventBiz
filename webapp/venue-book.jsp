...
<html>
<head>
<title>Book <%= v.getName() %> - EventBiz</title>
<style>
    ...
    * {
    ...
    body {
        ...
        padding: 0;
        min-height: 100vh;
        background: linear-gradient(rgba(45, 55, 75, 0.9), rgba(65, 85, 115, 0.95)), 
    ...
    h2 {
        ...
        text-align: center;
        margin-bottom: 2rem;
        background: linear-gradient(135deg, #8B4513 0%, #CD7F32 50%, #A0522D 100%);
    ...
    h2::after {
        ...
        width: 200px;
        height: 4px;
        background: linear-gradient(90deg, transparent, #8B4513, #CD7F32, #A0522D, transparent);
        border-radius: 2px;
...
<div class="booking-container">
    ...
    <div class="venue-info">
        ...
        <div class="venue-details">
            <div class="venue-detail">📍 <%= v.getLocation() %></div>
            <div class="venue-detail">👥 Capacity: <%= v.getCapacity() %></div>
        </div>
    </div>
    ...
    <form method="post" action="<%=request.getContextPath()%>/venue/book" class="booking-form">
        <input type="hidden" name="venue_id" value="<%= v.getId() %>"/>
        
        <div class="form-group">
            <label for="title">📝 Title / Purpose</label>
            <input type="text" id="title" name="title" required placeholder="Enter event title or purpose"/>
        </div>
        ...
        <button type="submit">🗓️ Book Venue</button>
    </form>
    
    <div class="back-link">
        <a href="<%=request.getContextPath()%>/venue/view?id=<%=v.getId()%>">⬅️ Back to Venue Details</a>
    </div>
</div>
